...
export default function StoryBox() {
  return (
    <div className='index__main__story'>
      {/* =TEXT */}
      <div className='index__main__storyTitle'>五十年傳承的生態養殖技術</div>
      <div className='index__main__storyOutline'>
      ...
      {/* =LINK */}
      <a className='index__main__storyMore'>了解更多</a>
      {/* =IMAGE */}
      <picture className='index__main__storyImg'>
        <img src='/static/index_main_storyImg.jpg' alt='烏魚子製程' />
      </picture>
      {/* =BOTTOM */}
      <div className='index__main__storyCertificate'>
      ...
      <img className='index__main__storyBackground' src='/static/index_main_storyBackground.jpg' alt='茂洋烏魚子'></img>
    </div>
  )
}
